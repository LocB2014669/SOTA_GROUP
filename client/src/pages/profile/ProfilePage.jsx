  ...
  return (
    <MainLayout>
      <section className="max-w-6xl mx-auto">
        ...
        <ModalCart/>
        <article className="flex gap-x-5 my-5">
          <div className="w-1/4">
            <div className="mb-5">
            ...
            <div className="relative">
              <div className="flex flex-col w-full lg:overflow-y-visible overflow-y-auto">
          ...
          <div className="w-3/4">{tabsData[activeTabIndex].content}</div>
