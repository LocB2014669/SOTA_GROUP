                            ...
                            <ul class="nav nav-treeview">
                                ...
                                ?>
                                        ...
                                        <li class="nav-item <?= $none ?>">
                                            <a class="nav-link <?= $active ?>" href="index.php?com=product&act=man&type=<?= $k ?>" title="<?= $v['title_main'] ?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p><?= $v['title_main'] ?></p>
                                            </a>
                                        </li>
                                        ...
                                        <?php if (isset($v['size']) && $v['size'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_size&type=<?= $k ?>" title="Kích thước"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Kích thước</p>
                                                </a></li>
                                        <?php } ?>
                                        <?php if (isset($v['dungtich']) && $v['dungtich'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_dungtich&type=<?= $k ?>" title="Dung tích"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Dung tích</p>
                                                </a></li>
                                        <?php } ?>
                                        <?php if (isset($v['dvt']) && $v['dvt'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_dvt&type=<?= $k ?>" title="Xuất xứ"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Đơn vị tính</p>
                                                </a></li>
                                        <?php } ?>
                                        ...
                                        <?php if (isset($v['price']) && $v['price'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_price&type=<?= $k ?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Khoản giá</p>
                                                </a></li>
                                        <?php } ?>
                                        ...
                                        <?php if (isset($v['import_price']) && $v['import_price'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>">
                                                <a class="nav-link <?= $active ?>" href="index.php?com=import_price&act=man&type=<?= $k ?>" title="import"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Cập nhật giá</p>
                                                </a>
                                            </li>
                                        <?php } ?>
                                ...
                                ?>
                                    <li class="nav-item <?= $none ?>">
                                        <a class="nav-link <?= $active ?>" href="index.php?com=seopage&act=capnhat&type=<?= $k ?>" title="SEO page <?= $v['title_main'] ?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                            ...
                            <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php if (isset($v['doday']) && $v['doday'] == true) {
                                        ...
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_doday&type=<?= $k ?>" title="Danh mục Độ dày"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Độ dày</p>
                                            </a></li>
                                    <?php } ?>
